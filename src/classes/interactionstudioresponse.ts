...
export default class InteractionStudioResponse {
	...
	public static getFromResponseBody(body: any, config: InteractionStudioConfig) {
		...
		isResponse.attribute4 = campaignResponse?.payload?.attribute4 || ""
		isResponse.attribute5 = campaignResponse?.payload?.attribute5 || ""
		isResponse.attribute6 = campaignResponse?.payload?.attribute6 || ""
		...
		if (campaignResponse?.serverSideMessages !== undefined) {
			campaignResponse.serverSideMessages.forEach((message: any) => {
				...
				isResponse.attribute4 = message?.dataMap?.attribute4 || isResponse.attribute4
				isResponse.attribute5 = message?.dataMap?.attribute5 || isResponse.attribute5
				isResponse.attribute6 = message?.dataMap?.attribute6 || isResponse.attribute6
