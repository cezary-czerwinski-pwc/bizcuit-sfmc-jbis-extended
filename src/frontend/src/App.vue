<template>
	<div id="app">
		...
		<div class="tags mt-3">
			...
			<span class="tag is-link" v-html="'{{Interaction.' + (activity ? activity.key : '') + '.attribute4}}'"></span>
			<span class="tag is-link" v-html="'{{Interaction.' + (activity ? activity.key : '') + '.attribute5}}'"></span>
			<span class="tag is-link" v-html="'{{Interaction.' + (activity ? activity.key : '') + '.attribute6}}'"></span>
		</div>
